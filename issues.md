...
|**Status**|Этап, на который в данный момент находится проблема, находится на жизненном цикле
...
|**Fix Versions**|Версия (ы) проекта, в которой проблема была (или будет) исправлена.
...
|---|---|---|
|**ObjectID**|587973|Код в системе
|**Subject**|Ошибка в отчете 1111|Описание проблемы
|**Description**|Краткое описание проблемы|Краткое описание проблемы
|**Customer**|IvanovRS|Инициатор
|**ContactInfo**|Иванов Роман Семенович|Полное имя инициатора
|**ClassTier1**|22222222|Код в системе
|**ClassTier2**|33333333|Код в системе
|**ClassTier3**|incident|Тип 
|**CustomInfluenceCode**|2|ID типа
|**Deadline**|2012-12-1|Дата решения
|**CustomAgreementNum**|0001|Код  в проекта системе
|**CustomSystemName**|CODE001|Код в проекта системе
...
|Field|Sample|Description
|---|---|---|
|**N пп**|Номер по порядку
|**Заказчик**|Имя заказчика
|**ID заявки**|В системе ОТ
|**Дата заявки**|Дата размещения в системе ОТ
|**Разработчик**|Код разработчика подрядчика
|**Краткое описание**|Краткое описание
|**Комментарий**|Коментарий пользователя
...
|Field|Description
|---|---|
|**Id jira**|Номер по порядку JIRA
|**Id ot**|Номер по порядку OT
|**Created jira**|Дата время создания в jira
|**Created ot**|Дата время создания в ОТ
|**Updated jira**|Дата время создания в jira
|**Updated ot**|Дата время создания в ОТ
|**Project**|Код проекта в JIRA
|**Developer**|Имя разработчика
|**Due Date**|Плановая дата выполнения
|**Fact Date**|Действительная дата выполнения
|**Days**|Расчетное время на выполнение задачи в днях
|**Description**|Краткое описание
|**Comment**|Коментарии 
|**Percent**|Процент выполнения
|**Initiator**|Инициатор со стороны заказчика
|**Approve**|Утвердил со стороны заказчика
|**Proirity**|Приоритет 
|**Release**|Релиз в который войдет эта заявка
|**Тип**|Баг, дополнение, фитча
|**Status**|Сататусы 
...
#|Status JIRA|Status OT|Description
|---|---|---|---
|1|1|
...
#|Status OT|Description
|---|---|---
|1| **Отправлен** | Отправлен на тестирование
|2| **Установлен**|Установлен в банке
|3| **Тестирование**| Идет тесирование 
|4| **Сборка** | Идет сборка релиза
|5| **Разработка**| Отправлен на тестирование
...
#|Status OT|Description
|---|---|---
|1| **Tst**|Test| Отправлен на тестирование
|2| **Bf**|BugFix|Исправление срочных задач
|3| **Rc**|Release candidat| Предварительное внедрение
|4| **Rls**|Release | Идет сборка релиза
|5| **Tstbank**|Test to custumer| Отправлен на тестирование
