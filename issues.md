...
||Оставаясь Эстимейт , т.е. текущей оценки оставшегося количества времени , необходимым для решения этой проблемы.
||Сумма времени, затраченного на каждый из отдельных журналов работы для этой проблемы.
||Если вы используете Bitbucket для управления репозиториями кода, вы можете создавать ветви кода в своих инструментах разработки кода непосредственно из проблем JIRA.
||Давайте рассмотрим вашу проблему на вашей плате Scrum или Kanban.
